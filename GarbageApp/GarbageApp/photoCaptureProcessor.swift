...
//  GarbageApp
//
//  Created by Chad  Paik on 2021-02-15.
//
...
//    Init takes multiple closures to be called in each step of the photco capture process
    // anything with @escape is something called a closure
    // closure is basically a function in a variable
    // @escaping is used when the closure will escape its scope
